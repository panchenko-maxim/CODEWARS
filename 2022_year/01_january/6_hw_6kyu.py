...
a or b might be nil or null or None or nothing (except in C++, Crystal, D, Dart, Elixir, Fortran, F#, Haskell, Nim,
...
def comp(array1=None, array2=None):
    if type(array1) != list and type(array2) != list:
        return False
    elif type(array2) != list:
        return False
    elif array1 in [None, 0] or len(array1) != len(array2):
        return False
    else:
        lst = []
        for el in array1:
