...
get on the bus (the first item) and the number of people that 
...
var number = function(busStops){
    let people_in_bus = busStops[0][0] - busStops[0][1];
    for (let i = 1; i != busStops.length;i++){
        people_in_bus = people_in_bus + busStops[i][0] - busStops[i][1] ;
    }
